# CompoundGovernor
[Git Source](https://github.com/woof-software/compound-governance/blob/c11c1f171333a62ec14d59f19bba7db61c5df459/contracts/CompoundGovernor.sol)
...
*This is the address of the proxy admin that will be used to upgrade the proxy and call batchWhitelist.*
...
### MIN_PROPOSERS
Minimum number of proposers that must remain in the allowed proposers list.
...
Maximum lifetime for a temporary proposer.
...
Function selector for setProposalGuardian(ProposalGuardian).
...
### allowedProposers
A set of addresses that are allowed to make proposals.

*Using EnumerableSet for managing the allow list.*
...
Batch initializes the allowed proposers list during upgrade.

*This function can only be called once during the upgrade process.*
...
|Name|Type|Description|
|----|----|-----------|
|`_initProposers`|`address[]`|Array of addresses to add to the allowed proposers list.|
...
*This function can be called by the proposer or proposal guardian.*
...
*Only an allowed proposer can call this function to whitelist other accounts.*
...
Adds a new address to the allowed proposers list.

*Only the executor (timelock) or proposal guardian (when below minimum proposers) can call this function.*
...
|Name|Type|Description|
|----|----|-----------|
|`_newProposer`|`address`|The address to add to the allowed proposers list.|


### removeProposer

Removes an address from the allowed proposers list.
...
|Name|Type|Description|
|----|----|-----------|
|`_proposer`|`address`|The address to remove from the allowed proposers list.|
...
Returns the list of allowed proposers.
...
|Name|Type|Description|
|----|----|-----------|
|`<none>`|`address[]`|address[] An array of addresses that are allowed to make proposals.|


### isAllowedProposer

Checks if an address is in the allowed proposers list.
...
|Name|Type|Description|
|----|----|-----------|
|`<none>`|`bool`|bool True if the address is an allowed proposer.|


### isProposalGuardianExpired

Checks if the proposal guardian has expired.
...
|Name|Type|Description|
|----|----|-----------|
|`<none>`|`bool`|bool True if the proposal guardian has expired, false otherwise.|


### _isValidProposalWhenGuardianExpired

Validates that a proposal contains exactly one setProposalGuardian call.
...
|Name|Type|Description|
|----|----|-----------|
|`<none>`|`bool`|bool True if the proposal contains exactly one setProposalGuardian call, false otherwise.|
...
*Updates the proposal guardian and emits a [ProposalGuardianSet](/contracts/CompoundGovernor.sol/contract.CompoundGovernor.md#proposalguardianset) event.
...
*To use the `EnumerableSet` library for managing a set of addresses.*
...
|Name|Type|Description|
|----|----|-----------|
|`setter`|`address`|The address of the account that set the expiration.|
...
### ProposerAdded
Emitted when a new proposer is added to the allowed proposers list.
...
|Name|Type|Description|
|----|----|-----------|
|`proposer`|`address`|The address of the proposer that was added.|

### ProposerRemoved
Emitted when a proposer is removed from the allowed proposers list.
...
|Name|Type|Description|
|----|----|-----------|
|`proposer`|`address`|The address of the proposer that was removed.|
...
### ZeroAddress
Error thrown when a zero address is used.
...
### ZeroAddressAtIndex
Error thrown when a zero address is used at a specific index.
...
|Name|Type|Description|
|----|----|-----------|
|`index`|`uint256`|The index where the zero address was used.|

### OnlyAllowedProposers
Error thrown when a caller is not an allowed proposer.
...
### AlreadySet
Error thrown when an account is already set.
...
|Name|Type|Description|
|----|----|-----------|
|`account`|`address`|The address of the account that is already set.|

### IsProposalGuardian
Error thrown when an account is the proposal guardian.
...
|Name|Type|Description|
|----|----|-----------|
|`account`|`address`|The address of the account that is the proposal guardian.|

### ExceedsMaxLifetime
Error thrown when an account's lifetime exceeds the maximum lifetime.
...
|Name|Type|Description|
|----|----|-----------|
|`account`|`address`|The address of the account that exceeds the maximum lifetime.|

### NotInAllowedProposers
Error thrown when an account is not in the allowed proposers list.
...
|Name|Type|Description|
|----|----|-----------|
|`account`|`address`|The address of the account that is not in the allowed proposers list.|

### BelowMinimumProposers
Error thrown when amount of allowed proposers is below the minimum proposers.
...
Error thrown during batchWhitelist when the first address is not the proposal guardian.
...
|Name|Type|Description|
|----|----|-----------|
|`account`|`address`|The address of the account that is not the proposal guardian.|

### DuplicateAddress
Error thrown during batchWhitelist when an account is duplicated.
...
### MinProposersReached
Error thrown when the minimum number of proposers is reached.

*This error is thrown when the proposal guardian tries to add an allowed proposer when the minimum number of
...
Error thrown when a proposal is invalid because the proposal guardian has expired and only
...
### OnlyProxyAdmin
Error thrown when the caller is not the proxy admin.
...
Error thrown when the caller is not the proposer or the proposal guardian.
