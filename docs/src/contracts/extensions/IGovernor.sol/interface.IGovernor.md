# IGovernor
[Git Source](https://github.com/woof-software/compound-governance/blob/c11c1f171333a62ec14d59f19bba7db61c5df459/contracts/extensions/IGovernor.sol)
...
*A description of the possible `support` values for [castVote](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#castvote) and the way these votes are counted, meant to
...
*The time when a queued proposal becomes executable ("ETA"). Unlike [proposalSnapshot](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#proposalsnapshot) and
...
Consequently this value must fit in a uint48 (when added to the current clock). See [IERC6372-clock](/lib/openzeppelin-contracts-upgradeable/test/governance/Governor.t.sol/contract.GovernorInternalTest.md#clock).*
...
NOTE: The [votingDelay](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#votingdelay) can delay the start of the vote. This must be considered when setting the voting
...
*Create a new proposal. Vote start after a delay specified by [IGovernor-votingDelay](/lib/openzeppelin-contracts-upgradeable/test/governance/Governor.t.sol/contract.GovernorInternalTest.md#votingdelay) and lasts for a
...
Emits a [ProposalQueued](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#proposalqueued) event.*
...
Emits a [ProposalExecuted](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#proposalexecuted) event.
...
Emits a [ProposalCanceled](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#proposalcanceled) event.*
...
*Cast a vote
Emits a [VoteCast](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#votecast) event.*
...
Emits a [VoteCast](/contracts/extensions/IGovernor.sol/interface.IGovernor.md#votecast) or {VoteCastWithParams} event depending on the length of params.*
...
See [Governor-_encodeStateBitmap](/lib/openzeppelin-contracts-upgradeable/contracts/governance/GovernorUpgradeable.sol/abstract.GovernorUpgradeable.md#_encodestatebitmap).*
...
If the `voter` is a contract, the signature is not valid using [IERC1271-isValidSignature](/lib/openzeppelin-contracts-upgradeable/contracts/mocks/ERC1271WalletMockUpgradeable.sol/contract.ERC1271WalletMockUpgradeable.md#isvalidsignature).*
...
*The `account` is not whitelisted or not whitelisted permanently to propose.*
