...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV3, GovernorBravoEvents {
    ...
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 100_000e18; //100,000 Comp
    ...
    /**
     * @notice Cancels a proposal if sender is the proposer or proposalGuardian. Can be called by anyone if the proposer
    ...
    function cancel(uint256 proposalId) external {
        ...
        if (msg.sender != proposal.proposer && msg.sender != proposalGuardian) {
            ...
            // Only whitelist guardian can cancel proposals from whitelisted proposers with delegations below the
            // proposal threshold
    ...
    /**
     * @notice Admin function for setting the whitelist expiration as a timestamp for an account. Whitelist status
    ...
    /**
     * @notice Admin function for setting the whitelistGuardian. WhitelistGuardian can cancel proposals from whitelisted
     * addresses
